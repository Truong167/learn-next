                ...
                <form className="space-y-8 pb-10" onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <div className="space-y-2 w-full">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">Detailed instructions for AI Behaivor</p>
                        </div>
                        <Separator className="bg-primary/10" />
                    </div>
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormDescription>
                                    Describe in detail your companion&aps;s backstory and relevant details.
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
